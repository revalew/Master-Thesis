...
class RequestParser:
    ...
    def parse_request(self, raw_request):
        ...
        if len(raw_request) > 0:
            ...
            if len(request_lines) > 1:
                ...
                while (
                    line_num < len(request_lines) and len(request_lines[line_num]) != 0
                ):
    ...
    def parse_content_form_data(self):
        ...
        while line_num < len(self.content):
            ...
            while (
                line_num < len(self.content)
                and self.content[line_num].find(self.boundary) == -1
            ):
                line_num += 1
            # check end of lines
            ...
            while (
                line_num < len(self.content)
                and self.content[line_num].find("Content-Disposition:") == -1
