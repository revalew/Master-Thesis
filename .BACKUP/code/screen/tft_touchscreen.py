...
# HOW can I change those pins to either 0-7 or 26-29 (Waveshare RP2040-Zero has them on top)
# TP_CS    = 16
# TP_IRQ   = 17
TP_CS    = 6
TP_IRQ   = 7
...
class LCD_3inch5(framebuf.FrameBuffer):
    ...
    def __init__(self):
        ...
        self.width = 480
        self.height = 160
        # self.height = 320 # Waveshare 4" TFT touch Shield for Arduino resolution is 480x320
